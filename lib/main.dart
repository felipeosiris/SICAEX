...
import 'package:SICAE/pages/login_page.dart';
import 'package:SICAE/pages/page_qrgenerator.dart';
import 'package:SICAE/pages/pages.dart';
import 'package:SICAE/utils/no_animation_page_transitions_builder.dart';
      ...
      pageBuilder: (context, animation, secondaryAnimation) {
        ...
        return SelectionArea(
          child: switch (pathName) {
            '/' => AuthState().isAuthenticated ? ListPage() : const LoginPage(),
            ...
            AttendancePage.name => const AttendancePage(),
            StudentsPage.name => const StudentsPage(),
            QrgeneratorPage.name => QrgeneratorPage(),
            AdministrationPage.name => const AdministrationPage(),
            PreviewPage.name => const PreviewPage(
                nameArgument: '',
