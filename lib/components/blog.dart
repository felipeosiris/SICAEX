...
import 'package:SICAE/components/color.dart';
import 'package:SICAE/components/spacing.dart';
import 'package:SICAE/components/text.dart';
import 'package:SICAE/components/typography.dart';
    ...
    return RawMaterialButton(
      ...
      child: Text(
        ...
        style: const TextStyle(
            color: Colors.white, fontSize: 14, fontFamily: 'sans-serif'),
      ),
    );
  }
}
                              ...
                              children: [
                                ...
                                ListTile(
                                  ...
                                  onTap: () {
                                    Navigator.pop(context);
                                    Navigator.pushNamed(
                                        context, AdministrationPage.name);
                                  },
                                ),
                                ListTile(
                  ...
                  child: Container(
                    ...
                    child: Wrap(
                      children: [
                        ...
                        TextButton(
                          onPressed: () =>
                              Navigator.pushNamed(context, StudentsPage.name),
                          style: menuButtonStyle,
                          child: const Text(
                            "ALUMNOS",
                          ),
                        ...
                        TextButton(
                          onPressed: () =>
                              Navigator.pushNamed(context, AttendancePage.name),
                          style: menuButtonStyle,
                          child: const Text(
                            "LISTA DE ASISTENCIA",
                          ),
