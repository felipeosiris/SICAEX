...
import 'package:SICAE/routes.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget buildPage(String name) {
    switch (name) {
      ...
      case AttendancePage.name:
        return const AttendancePage();
      case StudentsPage.name:
        return const StudentsPage();
      case QrgeneratorPage.name:
        return  QrgeneratorPage();
      case PreviewPage.name:
        return const PreviewPage(nameArgument: '', friendlyNameArgument: '', gradeArgument: '', groupArgument: '');
      default:
